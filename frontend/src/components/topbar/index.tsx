...
const TopBar = () => {
    ...
    const { currentDate, selectedClub: { settings: { color, logoPath } } } = initialSlice.getInitialState();


    return (
        <div className="topbar" style={{ backgroundImage: `linear-gradient(to left, #1d2030, #1d2030, #1d2030, ${color})` }}>
